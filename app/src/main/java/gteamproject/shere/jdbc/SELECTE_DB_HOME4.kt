...
class SELECTE_DB_HOME4(val context: Context) : AsyncTask<String?, Void?, Void?>() {
    ...
    companion object{
        const val select_DB_HOME_sql ="SELECT user_id, file_num FROM exPlus WHERE file_num != 0 ORDER BY reg_date DESC LIMIT 1"
    }
