...
class SELECTE_DB_HOME3(val context: Context) : AsyncTask<String?, Void?, Void?>() {
    ...
    companion object{
        const val select_DB_HOME_sql ="SELECT user_id, file_num FROM exPlus WHERE file_num != 0 ORDER BY reg_date DESC LIMIT 2,1"
    }

    override fun onPreExecute() {
        // tv = (context as Activity).findViewById(R.id.img_num)
        tv1 = (context as Activity).findViewById(R.id.homeDB3)
        tv2 = (context as Activity).findViewById(R.id.homeDB3_3)
    }
